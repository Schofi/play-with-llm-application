...
# 指定模型
MODEL = '/home/xxx/data/modeldata/ckpt/Qwen1.5-1.8B-Chat'
...
# 准备数据集
train_dataset = CustomDataset("/home/xxx/data/modeldata/ckpt/data/chinese_med.json", tokenizer, device)
...
# 创建保存模型的目录
import os
save_directory = '/home/xxx/data/modeldata/ckpt/Qwen1.5-1.8B-Chat-24-10-16'
